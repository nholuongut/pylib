...
import nholuongut
from nholuongut.utils import log, getenvs2, isBlankOrNone, isInt, isHost, isPort, isStr, isList, validate_int
from nholuongut.utils import CodingError, InvalidOptionException, ERRORS, qquit  # , die
from nholuongut.utils import get_topfile, get_file_docstring, get_file_github_repo, get_file_version, plural
from nholuongut.utils import CriticalError, WarningError, UnknownError
...
class CLI(object):
    ...
    def __init__(self):
        ...
        self._utils_version = nholuongut.utils.__version__
...
#                raise
    ...
    def run(self):  # pragma: no cover
        raise CodingError('running nholuongut.CLI().run() - this should be abstract and non-runnable!'
