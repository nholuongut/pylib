...
"""
# ============================================================================ #
#                   PyUnit Tests for nholuongut Utils
# ============================================================================ #
"""
...
import nholuongut
from nholuongut import utils
from nholuongut.utils import *  # pylint: disable=wildcard-import,unused-wildcard-import


# pylint: disable=invalid-name,no-self-use

# class test_nholuongutUtils(unittest2.TestCase):
class UtilsTester(unittest.TestCase):
    ...
    # Class attributes - can still access via self.<attrib> as it's less typing than test_nholuongutUtils.<attrib>
    # libdir = libdir
    libfile = os.path.join(libdir, 'nholuongut', 'utils.py')
    myList = [1, 2, 3]
    mySet = set(myList)
    myTuple = (1, 2, 3)
    ...
    def test_get_file_version(self):
        filename = os.path.join(libdir, 'nholuongut', 'utils.py')
    ...
    def test_get_file_github_repo(self):
        self.assertEqual(get_file_github_repo(__file__), 'https://github.com/nholuongut/pylib')
...
# ============================================================================ #
    ...
    def test_isAwsHostname(self):
        ...
        self.assertFalse(isAwsHostname('nholuongut'))
    ...
    def test_isDomain(self):
        ...
        self.assertTrue(isDomain('nholuongut.com'))
        self.assertTrue(isDomain('1nholuongut.com'))
        ...
        self.assertFalse(isDomain('nholuongut'))
    ...
    def test_isDomainStrict(self):
        ...
        self.assertTrue(isDomainStrict('domain.local'))
        self.assertTrue(isDomainStrict('nholuongut.com'))
        self.assertTrue(isDomainStrict('1nholuongut.com'))
        ...
        self.assertFalse(isDomainStrict('nholuongut'))
    ...
    def test_isEmail(self):
        ...
        self.assertFalse(isEmail('nholuongut'))
    ...
    def test_isFqdn(self):
        ...
        self.assertFalse(isFqdn('hari@nholuongut.com'))
    ...
    def test_isHost(self):
        self.assertTrue(isHost('nholuongut.com'))
        self.assertTrue(isHost('nholuongut'))
    ...
    def test_isHostname(self):
        self.assertTrue(isHostname('nholuongut.com'))
        self.assertTrue(isHostname('nholuongut'))
        self.assertTrue(isHostname('a'))
        self.assertTrue(isHostname('1'))
        self.assertTrue(isHostname('nholuongut1.com'))
        self.assertTrue(isHostname('1nholuongut.com'))
    ...
    def test_isNoSqlKey(self):
        self.assertTrue(isNoSqlKey('nholuongut:check_riak_write.pl:riak1:1385226607.02182:20abc'))
        self.assertFalse(isNoSqlKey('nholuongut@check_riak_write.pl'))
...
# ============================================================================ #
    ...
    def test_curl_custom_request_handler(self):
        curl('www.google.com', request_handler='nholuongut.RequestHandler')

    # def test_curl_bs4(self):
    #     curl_bs4('www.google.com')

    # def test_curl_bs4_custom_request_handler(self):
    #     curl_bs4('www.google.com', request_handler='nholuongut.RequestBS4Handler')
    ...
    def test_support_msg(self):
        ...
        self.assertTrue(re.search('https://github.com/nholuongut/testrepo/issues', support_msg('testrepo')))
        self.assertTrue(re.search('https://github.com/nholuongut/DevOps-Python-tools/issues', support_msg('')))
        self.assertTrue(re.search('https://github.com/nholuongut/DevOps-Python-tools/issues', support_msg(None)))
        self.assertTrue(re.search('https://github.com/nholuongut/DevOps-Python-tools/issues', support_msg()))
        prog2 = nholuongut.utils.prog
        nholuongut.utils.prog = 'check_test'
        self.assertTrue(re.search('https://github.com/nholuongut/Nagios-Plugins/issues', support_msg(None)))
        nholuongut.utils.prog = prog2

    def test_support_msg_api(self):
        print(support_msg_api())
        # avoid assertRegexpMatches as it's only available >= 2.7
        self.assertTrue(re.search(r'API may have changed\. .* https://github.com/nholuongut/testrepo/issues',
                                  support_msg_api('testrepo')))
        self.assertTrue(re.search(r'API may have changed\. .* https://github.com/nholuongut/DevOps-Python-tools/issues',
                                  support_msg_api()))
...
# ============================================================================ #
    ...
    def test_validate_domain(self):
        ...
        self.assertTrue(validate_domain('nholuongut.com'))
        self.assertTrue(validate_domain('1nholuongut.com'))
...
# ============================================================================ #
    ...
    def test_validate_fqdn(self):
        self.assertTrue(validate_fqdn('www.nholuongut.com', 'name'))
...
# ============================================================================ #
    ...
    def test_validate_host(self):
        self.assertTrue(validate_host('nholuongut.com', 'name'))
        self.assertTrue(validate_host('nholuongut'))
...
# ============================================================================ #
    ...
    def test_validate_hostname(self):
        self.assertTrue(validate_hostname('nholuongut.com', 'name'))
        self.assertTrue(validate_hostname('nholuongut'))
        self.assertTrue(validate_hostname('a'))
        self.assertTrue(validate_hostname('1'))
        self.assertTrue(validate_hostname('nholuongut1.com'))
        self.assertTrue(validate_hostname('1nholuongut.com'))
...
# ============================================================================ #
    ...
    def test_validate_hosts(self):
        self.assertTrue(validate_hosts('nholuongut.com,hmaster.domain.com', 'name'))
        self.assertTrue(validate_hosts('nholuongut,broker1, broker2,broker3  ')) # intentional random comma whitespace
...
# ============================================================================ #
    ...
    def test_validate_host_list(self):
        self.assertTrue(validate_host_list(['nholuongut.com', 'hmaster.domain.com'], 'name'))
        self.assertTrue(validate_host_list(['nholuongut', 'broker1', 'broker2', 'broker3']))
...
# ============================================================================ #
    ...
    def test_validate_hostport(self):
        self.assertTrue(validate_hostport('nholuongut.com:80', 'name'))
        self.assertTrue(validate_hostport('nholuongut.com', name='name', port_optional=True))
        self.assertTrue(validate_hostport('nholuongut:443'))
    ...
    def test_validate_hostport_exception_port_not_optional(self):
        try:
            validate_hostport('nholuongut.com')
            raise AssertionError('validate_hostport() failed to raise exception for nholuongut.com ' +
...
# ============================================================================ #
    ...
    def test_validate_hostport_list(self):
        self.assertTrue(validate_hostport_list(['nholuongut.com:80', 'hmaster.domain.com:16010'], 'name'))
        self.assertTrue(validate_hostport_list(['nholuongut.com'], name='name', port_optional=True))
        self.assertTrue(validate_hostport_list(['nholuongut:443']))
    ...
    def test_validate_hostport_list_exception_port_not_optional(self):
        try:
            validate_hostport_list(['nholuongut.com'])
            raise AssertionError('validate_hostport_list() failed to raise exception ' +
                                 'for nholuongut.com when port not optional')
        except InvalidOptionException:
            pass
...
# ============================================================================ #
    ...
    def test_validate_krb5_realm(self):
        ...
        self.assertTrue(validate_krb5_realm('nholuongut.com'))
        self.assertTrue(validate_krb5_realm('1nholuongut.com'))
    ...
    def test_validate_krb5_realm_exception(self):
        try:
            validate_krb5_realm('nholuongut')
...
# ============================================================================ #
    ...
    def test_validate_nosql_key(self):
        self.assertTrue(validate_nosql_key('nholuongut:check_riak_write.pl:riak1:1385226607.02182:20abc'))
        self.assertTrue(validate_nosql_key('nholuongut:check_riak_write.pl:riak1:1385226607.02182:20abc', 'name'))

    def test_validate_nosql_key_exception(self):
        try:
            validate_nosql_key('nholuongut@check_riak_write.pl')
